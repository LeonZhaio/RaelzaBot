...
const fgclink = {
 ...
 /* conn.reply(korban + '@s.whatsapp.net', spam1, fgclink, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/adam_daniam',
    mediaType: 2, 
    description: sgc,
